...
insert into bank.Customer(CId,CName,CEmail,Contact) values ('1','Sam','sam@yahoo.com','1234567895')
insert into bank.Customer(CId,CName,CEmail,Contact) values ('2','Rohit','roh@gmail.com','8974563214')
insert into bank.Customer(CId,CName,CEmail,Contact) values ('5','Harish','harish@yahoo.com','97458231')